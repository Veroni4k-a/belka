Оглавление
Глоссарий 3Введение 6
Глава 1. «Проектирование автономного роботизированного комплекса с системой компьютерного зрения» 8

1.1. Современное состояние робототехники и систем автономного навигации 81.2. Сравнительный анализ платформ для мобильной робототехники 91.3. Анализ систем технического зрения для задач обнаружения и трекинга объектов 111.4. Обоснование выбора аппаратной платформы и программного обеспечения 13
Глава 2. «Разработка автономного роботизированного комплекса» 17
2.1. Инструментарий и средства разработки проекта 172.2. Технические требования к проекту 182.3. Постановка задач и критерии успешности реализации 192.4. Проектирование и изготовление конструкционных элементов 192.5. Развертывание программно-аппаратного комплекса управления 202.6. Настройка системы связи и удаленного управления 212.7. Интеграция сенсорных систем и периферийных устройств 222.8. Разработка архитектуры программного обеспечения 232.9. Реализация системы управления двигателями и сервоприводами 252.10. Разработка алгоритмов компьютерного зрения для обнаружения человека 272.11. Реализация системы трекинга и преследования цели 282.12. Создание системы принятия решений и автономной навигации 302.13. Комплексное тестирование и валидация системы 32
Заключение 35Список используемых источников 36Приложения 37
